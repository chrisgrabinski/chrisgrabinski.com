...
const switchRootVariants = cva(
  "inline-flex aspect-1.75/1 rounded-switch bg-surface transition data-[state=checked]:bg-accent",
  {
    defaultVariants: {
      size: 3,
    },
...
const SwitchThumb = ({
  ...
  return (
    <SwitchPrimitive.Thumb
      ...
      {...props}
    >
      <div className="size-full rounded-switch bg-foreground transition group-data-[state=checked]/switch-thumb:bg-white" />
    </SwitchPrimitive.Thumb>
  );
};
